...
<tr> 
    <td width="100" class="a"><h3><strong>Article</strong></h3></td>
<td width="246" class="a">
<input id="choose" type="hidden" name="MAX_FILE_SIZE" value="2000000">
<input name="userfile" type="file" id="userfile"> 
</td>
<td width="80" class="a"><input name="upload" type="submit" class="box" id="upload" value=" Save Article "></td>
</tr>
                                                      </table>
                                                      </div>
      <div style="width: 50%; float:right">
...
<select name="services" class="services">
  <option value="ds">Drop Survey</option>
  <option value="rs">Rig Inspection</option>
  <option value="es">Electrical Safety</option>
  <option value="ed">Energy Audit</option>
</select>   
        </td>
        <td width="80" class="a">
