...
<head>
<meta charset="utf-8">
<title>Oil & Gas and Construction</title>
			...
			<div class="container">
				...
				<ul id="menu-main" class="nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown">Training</a>
                        ...
                        <li><a href="training.php#wacs">Work at Confined space</a></li>
                        <li><a href="training.php#ras">Rigging & Slinging</a></li>
                        <li><a href="training.php#hfai">Hand fingers & ingury</a></li>
                        <li><a href="training.php#hhc">Hazcom Hazard communication</a></li>
                        <li><a href="training.php#hhi">Hazid Hazard identification</a></li>
